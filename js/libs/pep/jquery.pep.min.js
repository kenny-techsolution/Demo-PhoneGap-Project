...
;(function ( $, window, undefined ) {
  ...
  Pep.prototype.subscribe = function () {
    ...
    this.$el.bind( this.startTrigger, function(ev){
      console.log("self disable",self.disabled);
      //this condition is necessary (kenny)
      if($(self.el).hasClass("pep-node")&&self.disabled==false){
    ...
    this.$document.bind( this.stopEvents, function(ev) {
      //console.log("trigger stop",ev.target);
      //ev.stopPropagation();
      self.handleStop(ev);
    });
  ...
  $.pep.toggleById = function(on,index){
    console.log(this);
      console.log("pep",this.peps);
    this.peps[index].toggle(on);
